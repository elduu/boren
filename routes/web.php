...
// Route for sending contract renewal emails
Route::get('/send-contract-renewal-emails', [EmailController::class, 'sendContractRenewalEmails']);

// Route for sending payment due emails
Route::get('/send-payment-due-emails', [EmailController::class, 'sendPaymentDueEmails']);
